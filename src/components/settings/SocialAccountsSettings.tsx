...
import { Share2, CheckCircle, AlertCircle, Settings, ExternalLink } from 'lucide-react';
...
export const SocialAccountsSettings = () => {
  ...
  const handleBulkConnect = () => {
    toast({
      title: "Bulk Connect",
      description: "This feature allows you to connect multiple accounts at once. Coming soon!",
      variant: "default"
    });
  };
    ...
    <div className="space-y-6">
        ...
        <CardContent>
          {connectedAccounts.length === 0 && (
            <Alert>
              ...
              <AlertDescription>
                No social media accounts connected. Connect your accounts to start publishing content directly.
              </AlertDescription>
            </Alert>
          )}
          {connectedAccounts.length > 0 && (
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-gray-600">
            Connect to your favorite social media platforms
          </p>
        </CardHeader>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3 text-sm text-gray-600">
            <p><strong>Step 1:</strong> Enter your username for each platform you want to connect</p>
            <p><strong>Step 2:</strong> Click "Connect" to establish the connection</p>
            <p><strong>Step 3:</strong> Test your connections to ensure they're working</p>
            <p><strong>Step 4:</strong> Start creating and publishing content directly from Postrilo</p>
          </div>
        </CardContent>
      </Card>
    </div>
